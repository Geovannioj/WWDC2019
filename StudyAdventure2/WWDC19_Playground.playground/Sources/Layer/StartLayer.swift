...
public class StartLayer: SKNode {
...
//    private var secondaireTitle: SKSpriteNode!
     ...
     */
    public  func setupScene(size: CGSize) {
     ...
     */
    public func setUpbackgroundImg(size: CGSize) {
     ...
     */
    public  func setCharacher(size:CGSize) {
    ...
    /**
     ...
     - parameters:- size: size of the screen
     */
    public  func setTapToStartButton (size: CGSize) {
...
//        addChild(secondaireTitle)
    ...
    public  func setStudentsUp(size: CGSize) {
        //Rotation angle
     ...
     */
    public  func setBooks(size: CGSize) {
        let amountOfBooks = 5
     ...
     */
    func setStudentSprite(gender: studentType,
                                  xProportion: CGFloat,
                                  yProportion: CGFloat,
                                  rotationAngle: Float,
        ...
        if gender == .femaleStudent {
            studentSprite = SKSpriteNode(imageNamed: "Women")
        } else {
            studentSprite = SKSpriteNode(imageNamed: "Men")
        }
     ...
     */
    public  func rotateSprite(sprite: SKSpriteNode,
                              angle: Float,
                              time: TimeInterval) {
