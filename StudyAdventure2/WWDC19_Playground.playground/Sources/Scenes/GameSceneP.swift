...
public class GameScene: SKScene, SKPhysicsContactDelegate  {
     ...
     */
    public  func setupGameLayer(size: CGSize) {
    ...
    /**
     ...
     - parameters: size: size of the screen to fit the layer
     */
    public  func setupHudLayer(size: CGSize) {
     ...
     */
    public func setUpGameScenePhysics() {
     ...
     */
    public func sceneTouched(touchLocation: CGPoint) {
    ...
    public func movimentationFunction() {
    ...
    public func enemyMovimentationFunction() {
     ...
     */
    public func setGameOverParameters(won: Bool) {
     ...
     */
    public func checkGameOver(countDown: Int, score: Int) {
